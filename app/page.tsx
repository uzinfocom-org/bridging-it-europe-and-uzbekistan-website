  ...
  return (
    <>
      <header className="mb-28">
        <Image
          className="absolute top-0 left-0 right-0 -translate-y-[calc(100%-160px)] mx-auto"
      ...
      <div className="absolute overflow-hidden">
        <Image
          className="mt-[200px] mx-auto mix-blend-screen scale-[2] w-full"
        ...
        <div className="flex justify-between mb-14">
          <div className="w-56">
            <div className="border border-[#20152F] rounded-4xl p-6 w-56">
              ...
              <h3 className="text-[#AEA2FF] text-lg">Skolas iela 2, Centra rajons, Rīga, LV-1010</h3>
            </div>
          </div>
          <div className="overflow-hidden">
            <div className="relative mb-8 mx-auto w-[416px] h-[52px] mask-no-repeat pointer-events-none" style={{ maskImage: `url(${bridgingMask.src})` }}>
            ...
            <div className="relative mx-auto w-[420px] h-[119px]">
              <div className="w-[420px] h-[119px] mask-no-repeat pointer-events-none" style={{ maskImage: `url(${itEuropeAndUzbekistanMask.src})` }}>
              ...
              <span className="absolute top-[30px] left-[180px] text-white text-stroke text-[46px] italic">&</span>
            </div>
          </div>
          <div className="w-56 text-right">
            <div className="border border-[#20152F] rounded-4xl p-6 w-40">
              <h2 className="text-8xl font-medium">8</h2>
              <h3 className="text-[#AEA2FF] text-2xl font-bold">October<br />2025</h3>
            </div>
          </div>
        </div>
        <a href="#register" className="mx-auto inline-flex text-[#AEA2FF] text-lg font-bold bg-linear-to-b from-[#E163FA] p-px rounded-4xl via-[#8D53EA] to-[#5158E4] mb-16">
          <span className="bg-black py-3 px-12 rounded-4xl">
            Register now
          </span>
        </a>
